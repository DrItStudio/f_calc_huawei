...
import 'package:wood_volume_calculator/screens/guide_pages/fast_guide.dart';
import 'package:wood_volume_calculator/screens/guide_pages/history_guide.dart';
import '../main_screen.dart';

class BfCalcGuideScreen extends StatelessWidget {
  const BfCalcGuideScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('m3_ai_title3'.tr()),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              'table_activation_hint'.tr(),
              style: Theme.of(context)
                  .textTheme
                  .titleLarge, // крупный, но меньше заголовка
            ),
            const SizedBox(height: 12),
            Image.asset('assets/images/Fast_BF.jpg'),
            const SizedBox(height: 12),
