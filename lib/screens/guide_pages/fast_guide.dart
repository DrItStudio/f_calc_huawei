...
import 'package:wood_volume_calculator/screens/guide_pages/bf_manual_guide.dart';
import 'classic_guide.dart'; // если classic_guide.dart лежит в той же папке
import '../main_screen.dart';

class FastGuideScreen extends StatelessWidget {
  const FastGuideScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('m3_ai_title2'.tr()),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Image.asset('assets/images/button_m3.jpg'),
            const SizedBox(height: 12),
