...
import 'classic_guide.dart'; // если classic_guide.dart лежит в той же папке
import 'fast_guide.dart';
import '../main_screen.dart';

class BfManualGuideScreen extends StatelessWidget {
  const BfManualGuideScreen({super.key});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('m3_ai_title1'.tr()),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text('m3_ai_title_bf'.tr(),
                style: Theme.of(context).textTheme.headlineSmall),
            const SizedBox(height: 12),
            Image.asset('assets/images/BF_manual.jpg'),
            const SizedBox(height: 12),
            ...
            const SizedBox(height: 8),
            Image.asset('assets/images/BF_m_method.jpg'),
            const SizedBox(height: 8),
            ...
            Text('m3_weight_output'.tr(),
                style: Theme.of(context).textTheme.titleSmall),
            Image.asset('assets/images/BF_m_weight.jpg'),
            ...[
              'm3_wo_vol_bark',
              'm3_wo_vol_net',
              'm3_wo_vol_bark2',
            ...
            Text('m3_units_title'.tr(),
                style: Theme.of(context).textTheme.titleMedium),
            Image.asset('assets/images/BF_b_setting.jpg'),
            ...[
              'm3_units1',
              'm3_units2',
              'm3_units3',
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (_) => ClassicGuideScreen()),
                    );
                  },
                  child: Text('back'.tr()),
                ),
                ElevatedButton(
                  ...
                  child: Text('main_screen'
                      .tr()), // Добавьте перевод "main_screen" в локализацию
                ),
                ElevatedButton(
                  onPressed: () {
                    Navigator.pushReplacement(
                      context,
                      MaterialPageRoute(builder: (_) => FastGuideScreen()),
                    );
                  },
